                       ...
                       for cc=0, n_elements(co2)-1 do begin
                          for mon=0, n_elements(monsize)-1 do begin
                             ...
                             if skipthis eq 0 then begin
                                ...
                                spawn, "cp PHOTOCHEM/out.od "+dirpath+"IO/"+runfolder+"/out"+strtrim(outcounter,1)+".od"
                                ...
                                spawn, "cp PHOTOCHEM/out.rates "+dirpath+"IO/"+runfolder+"/out.rates"+strtrim(outcounter,1)+".pt"
                                spawn, "cp PHOTOCHEM/out.params "+dirpath+"IO/"+runfolder+"/out.params"+strtrim(outcounter,1)+".pt"
                                spawn, "cp PHOTOCHEM/out.prod "+dirpath+"IO/"+runfolder+"/out.prod"+strtrim(outcounter,1)+".pt"
                                spawn, "cp PHOTOCHEM/out.gridz "+dirpath+"IO/"+runfolder+"/out.gridz"+strtrim(outcounter,1)+".pt"
                                ...
                                spawn, "cp PHOTOCHEM/out.dist "+dirpath+"IO/"+runfolder+"/out"+strtrim(outcounter,1)+".dist"
                                spawn, "cp PHOTOCHEM/out.rates "+dirpath+"IO/"+runfolder+"/out"+strtrim(outcounter,1)+".rates"
