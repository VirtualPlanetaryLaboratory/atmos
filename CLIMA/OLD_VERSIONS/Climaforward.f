...
c-as  the parameter translation to the photochemical model
      ...
      DO J=ND-1,1,-1
       ...
       FNC = 1. - FH2O - FCO2J
       AM = 18.*FH2O + 44.*FCO2J + DM2*FNC  ! AM is the weight of entire parcel (noncondensible + condensible)
