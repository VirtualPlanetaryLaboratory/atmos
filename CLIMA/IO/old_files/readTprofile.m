...
[ALT PTOT T FH2O O3 THEAT TCOOL PSATCO2 FCO2 ] = textread('clima_lastnon24501.tab','%f %f %f %f %f %f %f %f %f',101,'headerlines',1)
...
semilogy(T(1:n),PH2O(1:n),T(1:n),PSH2O(1:n),'r-.') 
set(gca, 'YDir', 'reverse')
xlabel('Temperature (K)')
