...
[JF PFF ALTF FTOTALF FTIRF FDNIRF FUPIRF FTSOLF FDNSOLF FUPSOLF DIVFF] = textread('F7200nomet/clima_allout.tab','%f %f %f %f %f %f %f %f %f %f %f', 101, 'headerlines', 132)
[JM PFM ALTM FTOTALM FTIRM FDNIRM FUPIRM FTSOLM FDNSOLM FUPSOLM DIVFM] = textread('M3600nomet/clima_allout.tab','%f %f %f %f %f %f %f %f %f %f %f', 101, 'headerlines', 132)
[JS PFS ALTS FTOTALS FTIRS FDNIRS FUPIRS FTSOLS FDNSOLS FUPSOLS DIVFS] = textread('Sunnomet/clima_allout.tab','%f %f %f %f %f %f %f %f %f %f %f', 101, 'headerlines', 132)
