...
[JF PFF ALTF FTOTALF FTIRF FDNIRF FUPIRF FTSOLF FDNSOLF FUPSOLF DIVFF] = textread('F7200/COLD_EARLYMARS/clima_allout1bar.tab','%f %f %f %f %f %f %f %f %f %f %f', 101, 'headerlines', 1056)
[JM PFM ALTM FTOTALM FTIRM FDNIRM FUPIRM FTSOLM FDNSOLM FUPSOLM DIVFM] = textread('M3600/M3600COLD/clima_allout1bar.tab','%f %f %f %f %f %f %f %f %f %f %f', 101, 'headerlines', 1356)
[JS PFS ALTS FTOTALS FTIRS FDNIRS FUPIRS FTSOLS FDNSOLS FUPSOLS DIVFS] = textread('COLDSUN_EarlyMars/clima_allout1bar.tab','%f %f %f %f %f %f %f %f %f %f %f', 101, 'headerlines', 1356)
