...
c-jdh Ethane k-coefficient weights
      DATA WEIGHTC2H6/0.08566,0.18038,0.23396,0.23396,0.18038,0.08566/ !gna - where did these come from?
...
!       TWGHT = weightco2_h2oIR(K1)*weightco2_h2oIR(K2)*weightch4(K3) ! with methane 8/27/2012
     ...
     &           *weightc2h6(K4) !even with no ethane twght still is affected by it...should we be doing this?
