...
c      CALL IREXPSUMS(WEIGHT,xkappa)
     ...
     &  kmatrix_irh2o, kmatrix_irco2) ! Outputting kmatrix_irco2 and kmatrix_irh2o because these quantities are not global, unlike in solar (where they are put in common blocks. 8/27/2012.
