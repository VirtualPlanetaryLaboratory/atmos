      ...
      if(species.eq.'CO2     ') LCO2=isP 
      if(species.eq.'N2      ') LN2=isP  
      if(species.eq.'H2SX    ') LH2SX=iSP     
      if(species.eq.'HSX     ') LHSX=iSP     
      if(species.eq.'SX      ') LSX=iSP         
      if(species.eq.'SXO     ') LSXO=iSP        
      if(species.eq.'SXO2    ') LSXO2=iSP       
      if(species.eq.'H2SXO4  ') LH2SXO4=iSP     
      if(species.eq.'HSXO    ') LHSXO=iSP       
      if(species.eq.'SXS     ') LSXS=iSP        
      if(species.eq.'SXO4AER ') LSXO4AER=iSP    
      if(species.eq.'SXS7AER ') LSXS7AER=iSP    
      if(species.eq.'SXO21   ') LSXO21=iSP      
      if(species.eq.'SXO23   ') LSXO23=iSP      
      if(species.eq.'HSXO3   ') LHSXO3=iSP      
      if(species.eq.'SXO3    ') LSXO3=iSP       
      if(species.eq.'SXS2    ') LSXS2=iSP       
      if(species.eq.'SXS3    ') LSXS3=iSP       
      if(species.eq.'SXS7    ') LSXS7=iSP       
      if(species.eq.'OCSX    ') LOCSX=iSP       
      if(species.eq.'OCSXS   ') LOCSXS=iSP              
      if(species.eq.'CS      ') LCS=iSP          !sorg's below    
      if(species.eq.'CS2     ') LCS2=iSP              
      if(species.eq.'CS2X    ') LCS2X=iSP        !excited CS2, not an isotope              
      ...
      if(species.eq.'CSX     ') LCSX=iSP          !sorg isotopes...    
      if(species.eq.'CSXS    ') LCSXS=iSP              
      if(species.eq.'CSXSX   ') LCSXSX=iSP        !excited CS2, isotopically substituted              
      if(species.eq.'CH3SX   ') LCH3SX=iSP              
      if(species.eq.'CH3SXH  ') LCH3SXH=iSP              
      if(species.eq.'C2H6SX  ') LC2H6SX=iSP              
      if(species.eq.'C2H6SXS ') LC2H6SXS=iSP              
      if(species.eq.'HCSX    ') LHCSX=iSP              
